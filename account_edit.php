...
if (file_exists('templates/'.CURRENT_TEMPLATE.'/module/account_edit.html')) {
	$main_content = $smarty->fetch(cseo_get_usermod(CURRENT_TEMPLATE.'/module/account_edit.html', USE_TEMPLATE_DEVMODE));
}else{
