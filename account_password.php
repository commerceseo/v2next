...
/* -----------------------------------------------------------------
 * 	$Id: account_password.php 873 2014-03-25 16:42:10Z akausch $
...
$cseo_account = cseohookfactory::create_object('AccountPasswordExtender');
...
if (file_exists('templates/'.CURRENT_TEMPLATE.'/module/account_password.html')) {
	$main_content = $smarty->fetch(cseo_get_usermod(CURRENT_TEMPLATE.'/module/account_password.html', USE_TEMPLATE_DEVMODE));
}else{
	$main_content = $smarty->fetch(cseo_get_usermod('base/module/account_password.html', USE_TEMPLATE_DEVMODE));
}
