<?php
/* -----------------------------------------------------------------
 * 	$Id: backup_restore.php 594 2013-09-10 16:12:54Z akausch $
 *
...
define('RESTORE_TEST', false); //Standard: false - auf true �ndern f�r Simulation f�r die Wiederherstellung, die SQL Befehle werden in eine Protokolldatei (log) im Backup-Verzeichnis geschrieben
//#################################
define('VERSION', 'Database Restore Ver. 2.2');
...
if ($action == 'restorenow') {
    ...
    //Protokollfatei l�schen wenn sie schon existiert
...
if (!empty($restore['file']) && $action != 'restorenow') {
    ...
    if ($restore['fileEOF']) {
        ...
        $button_back = '<a href="../login.php" class="button">Login</a>';
        $selbstaufruf = '';
        //echo $restore['test'];
        $restore = array();
        unset($_SESSION['restore']);
                        ...
                        <tr>
                            <td>
                                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="pageHeading"><?php echo HEADING_TITLE_BACKUP; ?><span class="smallText"> [<?php echo VERSION; ?>]</span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
