...
$order_query = xtc_db_query('SELECT *, COUNT(articlenumber) AS quantity FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "goods" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
$order_data = array();
...
$orderShip = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "shipment" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
...
$orderVoucher = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "voucher" AND articlenumber = "voucher" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
...
$orderCoupon = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "voucher" AND articlenumber = "coupon" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
...
$orderDiscount = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "voucher" AND articlenumber = "discount" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
...
$orderSurcharge = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "handling" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
...
$orderBVoucher = xtc_db_query('SELECT * FROM billsafe_orders_details_2 WHERE ordernumber = "'.$order_id.'" AND articletype = "voucher" AND articlenumber LIKE "backend-voucher-%" AND storno = 0 AND retoure = 0 GROUP BY articlenumber, articlename, articleprice;');
