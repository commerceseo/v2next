<?php
/* -----------------------------------------------------------------
* 	$Id: cseo_center_security.php 1210 2014-09-22 09:04:30Z akausch $
...
if (xtc_not_null($action)) {
	switch ($action) {
		...
		break;
		case 'cleanfaildlogin':
			if ($_GET['action'] == 'cleanfaildlogin') {
				xtc_db_query("UPDATE customers SET login_tries = '0';");
				xtc_redirect(xtc_href_link('cseo_center_security.php'));
			}
		break;
	}
...
<div class="row">
	<div class ="col-xs-12">
		<h2>Security Center 1.3 Beta</h2>
	</div>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#overview" data-toggle="tab">Overview</a></li>
		<li><a href="#logs" data-toggle="tab">SQL Logs</a></li>
		<li><a href="#serverlog" data-toggle="tab">Shop Logs</a></li>
		<li><a href="#faildlogin" data-toggle="tab">faild Logins</a></li>
...
<table class="table table-bordered table-striped">
	<tr>
		<th class="col-xs-6"><?php echo HEADING_SUM_NAME; ?></th>
		<th class="col-xs-6"><?php echo HEADING_SUM_COUNT; ?></th>
	</tr>
<?php 
$logging_table_query = xtc_db_query("SELECT * FROM customers WHERE login_tries > '0';"); 
...
echo '</tr>';
$logging_table_query = xtc_db_query("SELECT * FROM intrusions;"); 
...
<div class="tab-pane fade" id="serverlog">
<table class="table table-bordered table-striped">				
...
<div class="tab-pane fade" id="faildlogin">
<table class="table table-bordered table-striped">		
<?php 
$logging_table_query = xtc_db_query("SELECT * FROM customers WHERE login_tries > '0';"); 
echo xtc_draw_form('faildlog', 'cseo_center_security.php', 'action=cleanfaildlogin', 'post', '');
?>
		<tr>
	...
	<div class="col-xs-12">
		<input class="btn btn-info" name="truncatelogin" type="submit" value="zurück setzen">
	</div>
	</form>
</div>
