...
/* -----------------------------------------------------------------
 * 	$Id: blog_thumbnail_images.php 884 2014-03-27 13:00:52Z akausch $
...
$a = new image_manipulation(DIR_FS_CATALOG_IMAGES . 'blog_image/original_images/' . $products_image_name, PRODUCT_IMAGE_THUMBNAIL_WIDTH, PRODUCT_IMAGE_THUMBNAIL_HEIGHT, DIR_FS_CATALOG_IMAGES . 'blog_image/thumbnail_images/' . $products_image_name, IMAGE_QUALITY, '');
...
$array = clear_string(PRODUCT_IMAGE_THUMBNAIL_DROP_SHADDOW);
if (PRODUCT_IMAGE_THUMBNAIL_DROP_SHADDOW != '') {
