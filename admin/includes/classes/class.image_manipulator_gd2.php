...
/* -----------------------------------------------------------------
 * 	$Id: class.image_manipulator_gd2.php 1004 2014-05-05 21:01:16Z akausch $
...
// Any other images
            default:
                ...
                // imagecopyresized($dest, $source, $d_x, $d_y, $s_x, $s_y, $d_w, $d_h, $s_w, $s_h);
                return $dest;
        }
    }
...
// transparent colour, so ignore merging this pixel
    ...
    function smoth($smothwert) {
        imagefilter($this->t, IMG_FILTER_SMOOTH, $smothwert);
    }
