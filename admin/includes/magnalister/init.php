 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: init.php 3446 2014-01-14 21:00:39Z derpapst $
 *
...
if (isset($_GET['MLDEBUG']) && ($_GET['MLDEBUG'] == 'true')) {
    ...
    /* MLDEBUG allein gibt ein Testlauf, fuer echten Lauf mit Ausgabe setze OPERATE
       (bisher nur bei eBay) */
    if (isset($_GET['OPERATE']) && ($_GET['OPERATE'] == 'true')) {
        define('OPERATE', true);
    }
}
