...
class it_recht_kanzlei {
  ...
  function install() {
    ...
    xtc_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('MODULE_API_IT_RECHT_KANZLEI_TYPE_WRB', '10',  '6', '1', 'xtc_cfg_select_content(', 'xtc_cfg_display_content', now())");
