<?php
/**
 * @version $Id: adr_grl_import.class.php,v 1.1 2011-07-15 12:33:32 ag Exp $
 * @version $Revision: 1.1 $
 * @copyright Copyright (c) 2009 VARIO Software GmbH
 */

	class adr_grl_import extends vario_import {
		
		function adr_grl_import($exp_input){
			_debug($exp_input, 'START adr_grl_import -- Übergeben wurde der Datensatz $exp_input');
			...
			$this->set_fields(array(
				...
				'R_CSV_FELDLISTE' 	=> array(create_field_info(TABLE_CUSTOMERS_STATUS, 'customers_status_shipping_unallowed')),
			));
