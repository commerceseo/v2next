...
require_once(DIR_FS_CATALOG . 'includes/billpay/api/ipl_xml_api.php');
require_once(DIR_FS_CATALOG . 'includes/billpay/api/php4/ipl_xml_request.php');
require_once(DIR_FS_CATALOG . 'includes/billpay/api/php4/ipl_preauthorize_request.php');
