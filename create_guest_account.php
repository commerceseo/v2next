...
if (file_exists('templates/'.CURRENT_TEMPLATE.'/module/create_account_guest.html')) {
	$main_content = $smarty->fetch(cseo_get_usermod(CURRENT_TEMPLATE.'/module/create_account_guest.html', USE_TEMPLATE_DEVMODE));
}else{
