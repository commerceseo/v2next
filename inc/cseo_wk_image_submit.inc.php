...
/* -----------------------------------------------------------------
 * 	$Id: cseo_wk_image_submit.inc.php 866 2014-03-17 12:07:35Z akausch $
...
if (CSS_BUTTON_ACTIVE == 'true' || CSS_BUTTON_ACTIVE == 'css') {
    ...
    function cseo_wk_image_submit($image, $alt = '', $parameters = '', $mouseover = false, $mousedown = false) {
        $image_submit = '<input type="submit" class="css_wk_img_button" value="' . xtc_parse_input_field_data($alt, array('"' => '&quot;')) . '"';
        if (xtc_not_null($alt))
    ...
    function cseo_wk_image_submit($image, $alt = '', $parameters = '', $mouseover = true, $mousedown = true) {
