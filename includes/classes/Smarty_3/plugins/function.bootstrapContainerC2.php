<?php
/*-----------------------------------------------------------------
* 	$Id: function.bootstrapContainerC2.php 943 2014-04-08 13:26:37Z akausch $
...
function smarty_function_bootstrapContainerC2($Params=array(), &$smarty) {
	$left = false;
	$right = false;
	...
	if(PRODUCT_ID > 0 && strstr($_SERVER['REQUEST_URI'], FILENAME_SHOPPING_CART) === false && strstr($_SERVER['REQUEST_URI'], FILENAME_WISH_LIST) === false) {
		...
		if ($left && $right) {
			$css = 'col-md-9 col-sm-8 col-xs-12 fr';
