...
/* -----------------------------------------------------------------
 * 	$Id: order_details_print_wishlist.php 791 2014-01-02 11:54:43Z akausch $
...
$module = $module_smarty->fetch(cseo_get_usermod(CURRENT_TEMPLATE . '/module/print_wish_list_order_details.html', USE_TEMPLATE_DEVMODE));
