...
class ot_shipping {
    ...
    function ot_shipping() {
        ...
        $this->mwstautomat = ((AUTOMATIC_SHIPPING_TAX == 'true') ? true : false);
    ...
    function process() {
        ...
        if (xtc_not_null($order->info['shipping_method'])) {
            if ($_SESSION['customers_status']['customers_status_show_price_tax'] == 1) {
                if (AUTOMATIC_SHIPPING_TAX == 'true' && MODULE_ORDER_TOTAL_SHIPPING_TAX_CLASS > 0) {
    ...
    function keys() {
        return array('MODULE_ORDER_TOTAL_SHIPPING_STATUS', 'AUTOMATIC_SHIPPING_TAX', 'MODULE_ORDER_TOTAL_SHIPPING_SORT_ORDER', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER', 'MODULE_ORDER_TOTAL_SHIPPING_DESTINATION', 'MODULE_ORDER_TOTAL_SHIPPING_TAX_CLASS');
    }
    ...
    function install() {
        ...
        xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('AUTOMATIC_SHIPPING_TAX', 'false','6', '1','xtc_cfg_select_option(array(\'true\', \'false\'), ', now())");
