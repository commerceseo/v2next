...
class billpaytransactioncredit extends billpayBase {
	...
	function _extendSeoEula($selection, $eulaText, $onClickAction='') {
		$selection['fields'][] = array(
            'title' => '</dt>',
            'field' => '<input type="checkbox" name="'.$this->_getDataIdentifier('eula').'" '.$onClickAction.' style="display:block;float:left;">' . $eulaText);
		return $selection;
	}
    ...
    function _displaySepaBankData()
    {
        ...
        return $smarty->fetch('../includes/billpay/templates/bankdata_sepa_form.tpl');
    }
