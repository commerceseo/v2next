...
*/
  ...
  define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_INITIATION_URL','https://secure.wirecard-cee.com/qpay/init.php');
  define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_IFRAME','checkout_wirecard_checkout_page.php');
  define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PLUGINVERSION', '1.0.0');
...
class wirecard_checkout_page {
    ...
    function _preInvoiceCheck() {
        ...
        $consumerID = $_SESSION['customer_id'] != '' ? $_SESSION['customer_id'] : "";
    ...
    function before_process()
    {
        ...
        // write the state of the order in the database
