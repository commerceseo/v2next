...
/* -----------------------------------------------------------------
 * 	$Id: gls.php 420 2013-06-19 18:04:39Z akausch $
...
//print($query_string);
        ...
        $shipping = -1;
        $gls_table = preg_split("/[-:,]/", $gls_cost['gls_weight_price_string']);
        $n = 1;
        $y = 2;
...
// Table structure for table `gls_country_to_postal`
        if (xtc_db_query("CREATE TABLE gls_country_to_postal (gls_country char(2) NOT NULL default '', gls_postal_reference int(11) NOT NULL default '0', PRIMARY KEY  (gls_country))")) {
...
// Table structure for table `gls_postal_to_weight`
        if (xtc_db_query("CREATE TABLE gls_postal_to_weight (gls_postal_reference int(11) NOT NULL default '0', gls_from_postal varchar(10) NOT NULL default '', gls_to_postal varchar(10) NOT NULL default '', gls_weight_ref char(3) NOT NULL default '', PRIMARY KEY  (gls_postal_reference,gls_from_postal))")) {
...
// Table structure for table `gls_weight`
        if (xtc_db_query("CREATE TABLE gls_weight (gls_weight_ref char(3) NOT NULL default '', gls_weight_price_string text NOT NULL, gls_free_shipping_over decimal(15,4) NOT NULL default '-1.0000', gls_shipping_subsidized decimal(15,4) NOT NULL default '-1.0000', PRIMARY KEY  (gls_weight_ref))")) {
