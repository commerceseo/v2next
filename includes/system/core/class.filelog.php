...
/* -----------------------------------------------------------------
 * 	$Id: class.filelog.php 522 2013-07-24 11:44:51Z akausch $
...
class FileLog {
    ...
    function write($p_string) {
        ...
        if ((file_exists(DIR_FS_CATALOG . $this->get_file_path()) == false && is_writeable(DIR_FS_CATALOG . 'logfiles/') == false) || (file_exists(DIR_FS_CATALOG . $this->get_file_path()) == true && is_writeable(DIR_FS_CATALOG . $this->get_file_path()) == false)) {
            return false;
        }
