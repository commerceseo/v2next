...
define('BUTTON_CSEO_PORTAL', 'Zum commerce:SEO Kundenportal');
...
define('LABEL_DB_SALTKEY', 'Salt Key:');


# Headlines
define('HEADING_INSTALLATION_SERVICE', 'commerce:SEO v2 Next Installations-Service');
...
define('TEXT_SET_PERMISSIONS', 'Sie k&ouml;nnen die Rechte entweder selbst mit einem FTP-Programm oder &uuml;ber die FTP-Funktion des Installers setzen. F&uuml;r Letzteres geben Sie bitte im folgenden Formular Ihre FTP-Daten ein und klicken auf &quot;Verbinden&quot;.<br /> Anschlie&szlig;end navigieren Sie zum Verzeichnis, in dem sich der Shop befindet und starten die Rechtevergabe, indem Sie auf den Button &quot;Rechte setzen&quot; klicken.');
define('TEXT_ROBOTS','Klicken Sie auf &quot;Download&quot;, um die robots.txt f&uuml;r Ihren Shop zu generieren und herunterzuladen. Laden Sie die Datei mit einem FTP-Programm in das Haupt-Verzeichnis Ihres Webservers. Die Datei muss anschlie&szlig;end unter folgendem Link erreichbar sein: <a href="http://' . getenv('HTTP_HOST') . '/robots.txt" target="_blank">http://' . getenv('HTTP_HOST') . '/robots.txt</a>');
define('TEXT_SUCCESS','Wir gratulieren Ihnen zur Installation Ihres neuen Onlineshops und w&uuml;nschen Ihnen viel Erfolg und gute Ums&auml;tze!<br />Ihr commerce:SEO Service-Team.<br /><div class="button gradient red"">Sie sollten das installer Verzeichnis jetzt löschen!</div>');
...
define('ERROR_INPUT_MIN_LENGTH_6', 'Mindestzeichenanzahl von 6 nicht erreicht');
