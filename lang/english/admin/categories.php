<?php
/*-----------------------------------------------------------------
* 	$Id: categories.php 973 2014-04-14 06:01:52Z akausch $
...
define('TEXT_PRODUCTS_EXTRA_SHIPPING', 'Shipping charge:');
...
define('TEXT_PRODUCTS_MODEL', 'Model Nummer:');
...
define('TEXT_DEFAUL_SETTINGS', 'Preferences');
define('TEXT_ATTRIBUT_MANAGER', 'Attribute management');
define('TEXT_TEMPLATE_COLUMN', 'Which columns of the template to be displayed? ');
define('TEXT_TEMPLATE_COLUMN_TOP', ' 1 top');
define('TEXT_TEMPLATE_COLUMN_LEFT', ' 2 left column');
define('TEXT_TEMPLATE_COLUMN_RIGHT', ' 3 right column');
define('TEXT_TEMPLATE_COLUMN_BUTTON', ' 4 below');
define('TEXT_PAYMENT_METHOD', 'What method of payment is to be disabled for this Product?');
define('TEXT_SHIPPING_METHOD', 'What method of shipping is to be disabled for this Product?');
define('TEXT_EDIT_CATEGORIES_GOOGLE_TAX_TITLE', '<b>Google Taxonomie Category:</b>');
define('TEXT_EDIT_CATEGORIES_DESCRIPTION_FOOTER', 'Footer Description:');
define('TABLE_HEADING_SECTION','Section');
define('TXT_SECTION_STANDARD','Standard');
define('TXT_SECTION_ONE','Category 1');
define('TXT_SECTION_TWO','Category 2');
define('TXT_SECTION_THREE','Category 3');
define('TXT_SECTION_FOUR','Category 4');
define('TXT_SECTION_FIVE','Category 5');
define('TXT_SECTION_SIX','Category 6');
define('TXT_SECTION_SEVEN','Category 7');
define('TXT_SECTION_EIGHT','Category 8');
define('TXT_SECTION_NINE','Category 9');
define('TXT_SECTION_TEN','Category 10');
define('TXT_SECTION_ELEVEN','Category 11');
define('TEXT_PRODUCTS_BUNDLE','Product-Bundle ?: ');
define('TEXT_BUNDLE_NR','Bundle-Product-Nr. ');
define('HEADING_BUNDLE_NAME','Desription');
define('HEADING_BUNDLE_ID','ID');
define('HEADING_BUNDLE_QTY','QTY');
define('TEXT_BUNDLE_REM','("yes" or blank)');
define('TEXT_BUNDLE_ADD','Add Bundle-Product:');
define('TEXT_BUNDLE_DEL','[delete]');
define('TEXT_PRODUCTS_SPERRGUT', 'Bulk goods:');
define('TEXT_PRODUCTS_EKPPRICE','Einkauspreis');
