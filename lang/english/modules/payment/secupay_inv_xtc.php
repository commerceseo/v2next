...
define('MODULE_PAYMENT_SPINV_QRCODE_DESC','For a convenient online payment you can use the following web address or just scan the QR code with an internet capable smartphone.');
define('MODULE_PAYMENT_SPINV_QRCODE_PDF_DESC','For a convenient online payment you can use the following web address or just scan the QR code with an internet capable smartphone.');
...
define('MODULE_PAYMENT_SPINV_INVOICE_TEXT', "The invoice amount was assigned to secupay S.A., 19, rue de Bitbourg, L-1273 Luxemburg. <br><b>Payments with debt-discharging effect may only be made to the following account:</b><br><br>Account holder: secupay S.A.");
define('MODULE_PAYMENT_SPINV_INVOICE_TEXT_PDF', "The invoice amount was assigned to secupay S.A., 19, rue de Bitbourg, L-1273 Luxemburg. Payments with debt-discharging effect may only be made to the following account:\n\nAccount holder: secupay S.A.");
define('MODULE_PAYMENT_SPINV_INVOICE_TEXT_PDF_HINT', "The invoice amount was assigned to secupay S.A. Please pay to the following account:");
