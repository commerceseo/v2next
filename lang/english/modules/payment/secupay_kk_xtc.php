<?php
define('MODULE_PAYMENT_SPKK_TEXT_TITLE', 'secupay.Kreditkarte');
define('MODULE_PAYMENT_SPKK_TEXT_DESCRIPTION', "secupay.Kreditkarte - einfach.sicher.zahlen");
define('MODULE_PAYMENT_SPKK_TEXT_ERROR', 'Fehler bei dem Zahlvorgang!');

define('MODULE_PAYMENT_SPKK_STATUS_TITLE','secupay.Kreditkarte');
define('MODULE_PAYMENT_SPKK_STATUS_DESC','M&ouml;chten Sie Kreditkartenzahlungen &uuml;ber secupay abwickeln?');

define('MODULE_PAYMENT_SPKK_ZONE_TITLE','Zahlungszone');
define('MODULE_PAYMENT_SPKK_ZONE_DESC','F&uuml;r welche Zone soll secupay.Kreditkarte angezeigt werden?');
...
/*define('MODULE_PAYMENT_SPKK_KAEUFERSCHUTZ_TITLE','K&auml;uferschutz');
define('MODULE_PAYMENT_SPKK_KAEUFERSCHUTZ_DESC','Soll der K&auml;uferschutzhinweis w&auml;hrend des Bestellprozesses angezeigt werden?');*/

/*define('MODULE_PAYMENT_SPKK_GUARANTEE_TITLE','Zahlungsgarantie');
define('MODULE_PAYMENT_SPKK_GUARANTEE_DESC','M&ouml;chten Sie die Zahlungsgarantie in Anspruch nehmen?');*/
...
define('MODULE_PAYMENT_SPKK_MWST_DESC','M&ouml;chten Sie die MwSt. auf Versandkosten extra berechnen? (evtl. notwendig bei  Fehler im Shopsystem)');
...
define('MODULE_PAYMENT_SECUPAY_SPKK_TEXT_INFO','');

define('MODULE_PAYMENT_SECUPAY_KK_XTC_ALLOWED','');
define('MODULE_PAYMENT_SECUPAY_KK_XTC_TEXT_TITLE','Kreditkarte');

define('MODULE_PAYMENT_SPKK_DELIVERY_DISABLE_TITLE','Deaktivieren bei abweichender Lieferanschrift');
