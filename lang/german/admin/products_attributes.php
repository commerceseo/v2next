<?php
/*-----------------------------------------------------------------
* 	$Id: products_attributes.php 871 2014-03-20 09:13:14Z akausch $
...
define('TABLE_HEADING_OPT_DESC', 'Optionsbeschreibung');
define('TABLE_HEADING_OPT_IMAGE', 'Optionsbild');
define('TABLE_TEXT_DELETE', 'Optionsbild l&ouml;schen?');
...
2.  Optionswert zuweisen zb. "download"<br />
3.  Download-Produkte per FTP in das Verzeichnis download/ speichern.<br />
4.  Bei der Attributeverwaltung des Produkts erscheint nun ein Dropdown Feld mit den Files welche zur Verf&uuml;gung stehen.<br />
');
define('TEXT_OPTION_EMPTY_DEFAULT', 'Diesen Optionswert als Standardvorgabe definieren');
define('TABLE_COLORCODE', 'Farbcode:');
define('HEADING_TITLE_OPTION', 'Option:');