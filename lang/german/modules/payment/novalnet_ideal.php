...
define('MODULE_PAYMENT_NOVALNET_IDEAL_PAYMENT_LOGO_TITLE', '<a href="https://www.novalnet.de" target="_new"><img src="'.$img_src.'iDeal.png" alt="iDEAL" height = "25px" title="iDEAL" border="0"></a>');
