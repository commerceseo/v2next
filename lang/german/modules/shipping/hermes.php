<?php
/*-----------------------------------------------------------------
* 	$Id: hermes.php 496 2013-07-17 09:56:08Z akausch $
...
define('MODULE_SHIPPING_HERMES_TEXT_INFO', 'Hermes');
...
define('MODULE_SHIPPING_HERMES_TAX_CLASS_TITLE' , 'Steuersatz');
define('MODULE_SHIPPING_HERMES_TAX_CLASS_DESC' , 'W&auml;hlen Sie den MwSt.-Satz für diese Versandart aus.');
...
define('MODULE_SHIPPING_HERMES_COD_STATUS_TITLE' , 'Nachnahme aktivieren?');
define('MODULE_SHIPPING_HERMES_COD_STATUS_DESC' , 'Soll der Versand per Nachnahme aktiviert werden?');
