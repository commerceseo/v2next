...
/* --------------------------------------------------------------
  LogConfigurationPresets.inc.php 2014-11-17 gambio
  Gambio GmbH
  http://www.gambio.de
...
class LogConfigurationPresets {
    ...
    public static function load_group_error_handler_preset(LogConfiguration $p_coo_configuration) {
        ...
        $p_coo_configuration->set_for_level('notice');
        ...
        $p_coo_configuration->set_for_level_and_output('notice', 'code_snippet', false, false);
        $p_coo_configuration->set_for_level_and_output('notice', 'session_data', false, false);
