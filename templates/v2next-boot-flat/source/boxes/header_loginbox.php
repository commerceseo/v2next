<?php
/*-----------------------------------------------------------------
* 	$Id: header_loginbox.php 371 2013-06-10 12:44:12Z akausch $
...
if (!isset($_SESSION['customer_id'])) {
	...
	$box_smarty->assign('FIELD_EMAIL', xtc_draw_input_field('email_address', '', 'maxlength="50" tabindex="3" id="loginemail" required value="" placeholder="'.BOX_EMAIL_VALUE.'"'));
	$box_smarty->assign('FIELD_PWD', xtc_draw_password_field('password', '', 'maxlength="30" tabindex="4" placeholder="'.BOX_EMAIL_PASSWD.'" required id="loginpassword"'));
	...
	$box_smarty->assign('LINK_LOGIN', xtc_href_link(FILENAME_LOGIN, '', 'SSL'));
...
$box_content = $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_header_loginbox.html');

$smarty->assign('BOX_header_loginbox', $box_content);