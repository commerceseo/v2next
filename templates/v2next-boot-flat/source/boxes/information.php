<?php
/*-----------------------------------------------------------------
* 	$Id: information.php 371 2013-06-10 12:44:12Z akausch $
...
if (!$box_smarty->isCached(CURRENT_TEMPLATE.'/boxes/box.html', $cache_id) || !$cache) {
	...
	$getChild = xtc_db_fetch_array(xtDBquery("SELECT parent_id FROM content_manager WHERE content_group = '".$_GET['coID']."'"));
